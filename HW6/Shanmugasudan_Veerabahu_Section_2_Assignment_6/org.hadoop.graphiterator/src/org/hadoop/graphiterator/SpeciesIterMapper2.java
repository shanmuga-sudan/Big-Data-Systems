...
public void map(WritableComparable key, Writable value, 
  ...
  if (pages.length == 0) {
    ...
    for (String page : pages) { 
      if(page.length() > 0) {
    	  String temp_ValueKey=page; 						// .toString()
    	  temp_ValueKey=temp_ValueKey.replaceAll("=","");
    	  temp_ValueKey=temp_ValueKey.replaceAll("\\[","");
    	  temp_ValueKey=temp_ValueKey.replaceAll("\\]","");
    	  temp_ValueKey=temp_ValueKey.replaceAll("'","");
    	  temp_ValueKey=temp_ValueKey.replaceAll("\\|","");
    	  ...
    	  temp_ValueKey=temp_ValueKey.replaceAll("\\!", "");
    	  temp_ValueKey=temp_ValueKey.replaceAll("\\,", "");
    	  temp_ValueKey=temp_ValueKey.replaceAll(".&nbsp", "");
    	  temp_ValueKey=temp_ValueKey.replaceAll("\\*.png", "");
    	  temp_ValueKey=temp_ValueKey.replaceAll("\\_", "");
    	  temp_ValueKey=temp_ValueKey.replaceAll("\"", "");
    	  temp_ValueKey=temp_ValueKey.replaceAll("\\-", "");
    	  temp_ValueKey=temp_ValueKey.replaceAll("\\{", "");
    	  temp_ValueKey=temp_ValueKey.replaceAll("\\}", "");
    	  ...
    	  temp_ValueKey=temp_ValueKey.replaceAll("\\>", "");
    	  temp_ValueKey=temp_ValueKey.replaceAll("\\+", "");
    	  temp_ValueKey=temp_ValueKey.replaceAll("\\d","");
    	  page=temp_ValueKey;
...
//    	 System.out.println("The mapper ouput 0 is :"+page);
//      output.collect(new Text(page), new  Text(" " + pagetitle)); 
    }
  } 
  String temp_ValueKey=pagetitle; 						// .toString()
  temp_ValueKey=temp_ValueKey.replaceAll("=","");
  temp_ValueKey=temp_ValueKey.replaceAll("\\[","");
  temp_ValueKey=temp_ValueKey.replaceAll("\\]","");
  temp_ValueKey=temp_ValueKey.replaceAll("'","");
  ...
  temp_ValueKey=temp_ValueKey.replaceAll("\\+", "");
  temp_ValueKey=temp_ValueKey.replaceAll("\\d","");
  pagetitle=temp_ValueKey.trim();
  if(!(pagetitle.isEmpty())){
  // collect the inlink with its dampening factor, and all outlinks
  output.collect(new Text(pagetitle), new Text(".000000075"));
//  System.out.println("The mapper ouput 1 is :"+pagetitle+"000000075");
